package net.flashpunk
{
	...
	/**
	 * Main game Entity class updated by WorldFP.
	 */
	public class Entity extends Tweener
	{
		...
		/**
		 * X position of the Entity in the WorldFP.
		 */
		public var x:Number = 0;
		
		/**
		 * Y position of the Entity in the WorldFP.
		 */
		...
		/**
		 * Override this, called when the Entity is added to a WorldFP.
		 */
		...
		/**
		 * Override this, called when the Entity is removed from a WorldFP.
		 */
		...
		/**
		 * The WorldFP object this Entity has been added to.
		 */
		public function get world():WorldFP
		{
			return _world;
		}
		...
		/** @private */ internal var _world:WorldFP;

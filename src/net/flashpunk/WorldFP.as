package net.flashpunk
{
	 ...
	 */
	public class WorldFP extends Tweener
	{
		/**
		 ...
		 * Constructor.
		 */
		public function WorldFP() 
		{
			
		}
		
		/**
		 * Override this; called when WorldFP is switch to, and set to the currently active world.
		 */
		...
		/**
		 * Override this; called when WorldFP is changed, and the active world is no longer this.
		 */
		 ...
		 * If you override this to give your WorldFP update code, remember
		 ...
		 * If you override this to give your WorldFP render code, remember
		...
		/**
		 * X position of the mouse in the WorldFP.
		 */
		...
		/**
		 * Adds the Entity to the WorldFP at the end of the frame.
		...
		/**
		 * Removes the Entity from the WorldFP at the end of the frame.
		...
		/**
		 * Removes all Entities from the WorldFP at the end of the frame.
		 */
		...
		/**
		 * Adds an Entity to the WorldFP with the Graphic object.
		...
		/**
		 * Adds an Entity to the WorldFP with the Mask object.
		 ...
		 * @param	addToWorldFP		Add it to the WorldFP immediately.
		 * @return	The new Entity object.
		 */
		public function create(classType:Class, addToWorldFP:Boolean = true):Entity
		{
			...
			if (addToWorldFP) return add(e);
			return e;
		}
		
		/**
		 * Removes the Entity from the WorldFP at the end of the frame and recycles it.
		...
		/**
		 * How many Entities are in the WorldFP.
		 */
		public function get count():uint { return _count; }
		
		/**
		 * Returns the amount of Entities of the type are in the WorldFP.
		 * @param	type		The type (or Class type) to count.
		 * @return	How many Entities of type exist in the WorldFP.
		 */
		...
		/**
		 * Returns the amount of Entities of the Class are in the WorldFP.
		 * @param	c		The Class type to count.
		 * @return	How many Entities of Class exist in the WorldFP.
		 */
		...
		/**
		 * Returns the amount of Entities are on the layer in the WorldFP.
		...
		/**
		 * The first Entity in the WorldFP.
		 */
		public function get first():Entity { return _updateFirst; }
		
		/**
		 * How many Entity layers the WorldFP has.
		 */
		...
		/**
		 * The Entity that will be rendered first by the WorldFP.
		 */
		...
		/**
		 * The layer that will be rendered first by the WorldFP.
		 */
		...
		/**
		 * The layer that will be rendered last by the WorldFP.
		 */
		...
		/**
		 * How many different types have been added to the WorldFP.
		 */
		...
		/**
		 * Pushes all Entities in the WorldFP of the type into the Array or Vector.
		 * @param	type		The type to check.
		...
		/**
		 * Pushes all Entities in the WorldFP of the Class into the Array or Vector.
		 * @param	c			The Class type to check.
		 * @param	into		The Array or Vector to populate.
		 * @return	The same array, populated.
		 */
		...
		/**
		 * Pushes all Entities in the WorldFP on the layer into the Array or Vector.
		 * @param	layer		The layer to check.
		 * @param	into		The Array or Vector to populate.
		 * @return	The same array, populated.
		 */
		...
		/**
		 * Pushes all Entities in the WorldFP into the array.
		 * @param	into		The Array or Vector to populate.
		 * @return	The same array, populated.
		 */

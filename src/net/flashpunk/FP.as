package net.flashpunk 
{
	...
	public class FP 
	{
		...
		/**
		 * The currently active WorldFP object. When you set this, the WorldFP is flagged
		 * to switch, but won't actually do so until the end of the current frame.
		 */
		public static function get world():WorldFP { return _world; }
		public static function set world(value:WorldFP):void
		{
		...
		// WorldFP information.
		/** @private */ internal static var _world:WorldFP;
		/** @private */ internal static var _goto:WorldFP;

package net.flashpunk
{
	...
	public class Engine extends MovieClip
	{
		...
		/**
		 * Updates the game, updating the WorldFP and Entities.
		 */
		public function update():void
		{
			...
			if (FP._goto) checkWorldFP();
		}
		
		/**
		 * Renders the game, rendering the WorldFP and Entities.
		 */
		...
		/** @private Switch WorldFPs if they've changed. */
		private function checkWorldFP():void
		{
			if (!FP._goto) return;
			FP._world.end();
			FP._world.updateLists();
